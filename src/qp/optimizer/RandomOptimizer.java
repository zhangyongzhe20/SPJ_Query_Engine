        ...
        if (node.getOpType() == OpType.JOIN) {
            ...
            switch (joinType) {
                ...
                case JoinType.SORTMERGE:
                    ...
                    smj.setLeft(new Sort(left, OpType.SORT)); // TODO smj.setLeft(new Sort(left, leftAttrs, numbuff));
                    ArrayList<Attribute> rightAttrs = new ArrayList<>();
                    rightAttrs.add((Attribute) smj.getCondition().getRhs());
                    smj.setRight(new Sort(right, OpType.SORT)); // TODO smj.setRight(new Sort(right, rightAttrs, numbuff));
